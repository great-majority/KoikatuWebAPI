...
class EmocreWebAPI:
    ...
    scene_list_url = "http://upemocre.illusion.jp/manipulate_uploader_from_game_scene.php"
    chara_list_url = "http://upemocre.illusion.jp/manipulate_uploader_from_game_chara.php"
    ...
    def _from_tab_table(cls, url, params, data_types):
        ...
        df = df.applymap(lambda x: base64.b64decode(x).decode("utf-8") if not pd.isnull(x) else "")
