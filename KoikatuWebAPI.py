...
class KoikatuWebAPI:
    ...
    ranking_url="http://up.illusion.jp/koikatu_upload/chara/master/unity/koikatu_getChara.php"
    ...
    columns = ["id", "sex", "height", "bust", "hair", "personality", "blood_type", "day_of_birth", "club", "name", "nickname", "handle_name", "comment", "download_num", "uid", "weekly_download_num"]
...
def print_stat_poster(handle_name):
    ...
    print_columns = ["id", "name", "download_num", "weekly_download_num", "rank", "tie", "above"]
